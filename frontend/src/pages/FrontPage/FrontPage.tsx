                ...
                >
                  ...
                  >
                    <KeyboardDatePicker
                      ...
                      required
                      disableToolbar
                      invalidDateMessage={lang.invalidDate}
                      minDateMessage={lang.minDateError}
                      maxDateMessage={lang.maxDateError}
                      variant="inline"
                      format="dd.MM.yyyy"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={
                      (event) =>
                        void 0 /* handleCopyChange(event.target.name) */
                    }
                    name="observers"
                    color="primary"
                  />
